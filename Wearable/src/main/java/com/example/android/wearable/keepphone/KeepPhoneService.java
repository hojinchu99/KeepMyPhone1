...
/**
 * Creates a sound on the paired phone to Keep it.
 */
public class KeepPhoneService extends IntentService implements GoogleApiClient.ConnectionCallbacks,
    ...
    public KeepPhoneService() {
        super(KeepPhoneService.class.getSimpleName());
    }
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        if (Log.isLoggable(TAG, Log.VERBOSE)) {
            Log.v(TAG, "KeepPhoneService.onHandleIntent");
        }
        if (mGoogleApiClient.isConnected()) {
            ...
            if (intent.getAction().equals(ACTION_TOGGLE_ALARM)) {
                ...
                KeepPhoneActivity.updateNotification(this, notificationText);
            }
